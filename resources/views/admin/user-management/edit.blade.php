<x-app-layout>
    ...
    <div class="py-8 max-w-4xl mx-auto" x-data="{
        role: '{{ $user->hasRole('premium_user') ? 'premium_user' : $user->roles->first()->role_name ?? '' }}',
        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            ...
            <form action="{{ route('users.update', $user->id) }}" method="POST">
                ...
                <div class="mb-4" x-show="role === 'premium_user'">
                    <label class="block text-gray-700 font-medium">Premium Expired At</label>
                    <div class="flex items-center space-x-3 mt-1">
                        ...
                        <label class="inline-flex items-center">
                            ...
                            <span class="ml-2 text-gray-700 text-sm">Permanent</span>
                        </label>
                    </div>
                </div>
